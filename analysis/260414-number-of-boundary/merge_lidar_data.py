...
data_dir_opt = repo_root / "data" / "260414" / "processed"
output_file = data_dir_opt /  "merged_lidar_simulation_final.csv"
...
# CFD 文件列表 (Reference vs Sensitivity 1 vs Sensitivity 2)
cfd_files_ref = [
    "CFD_lidar_simulation_20250903_0000.csv",
    "CFD_lidar_simulation_20250903_0400.csv",
    "CFD_lidar_simulation_20250903_0800.csv",
    "CFD_lidar_simulation_20250903_1200.csv"
]
cfd_files_sen = [
    "CFD_lidar_simulation_20250903_0000_two_boundaries_as_outlet.csv",
    "CFD_lidar_simulation_20250903_0400_two_boundaries_as_outlet.csv",
    "CFD_lidar_simulation_20250903_0800_two_boundaries_as_outlet.csv",
    "CFD_lidar_simulation_20250903_1200_two_boundaries_as_outlet.csv"
]

def load_and_preprocess():
    print("Step 1: Loading WRF and Lidar data...")
    df_wrf = pd.read_csv(os.path.join(data_dir, "WRF_lidar_simulation_1h-rolling.csv"))
    df_lidar = pd.read_csv(os.path.join(data_dir, "lidar_1h-rolling.csv"))
    ...
    df_cfd_sen = process_cfd_files(cfd_files_sen)
    print(f"CFD Ref: {df_cfd_ref.shape}, CFE Sen: {df_cfd_sen.shape}")
