...
OUTPUT_DIR = REPO_ROOT / "results/ws_wd_station_profile" / cfg.RESULTS_TAG / "multi_time_grid"
...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--start",
        required=True,
        help="Start UTC time, e.g. '2025-09-09 06:00:00'. Will plot 6 hours from this time.",
    )
    p.add_argument(
        "--sites",
        nargs="+",
