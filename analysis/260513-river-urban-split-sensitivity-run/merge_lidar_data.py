...
data_dir_opt = repo_root / "data" / "260513" / "processed"
output_file = data_dir_opt / "merged_lidar_simulation_final_river_urban_split_sensitivity_run.csv"

# 目标时次
target_times = ["2025-09-03 05:00:00"]


# CFD 文件列表 (Reference vs Sensitivity)
cfd_files_ref = [f"CFD_lidar_simulation_20250903_0500_two_boundaries_as_outlet.csv"]

cfd_files_sen = [f"CFD_lidar_simulation_20250903_0500_two_boundaries_as_outlet-river_urban_split.csv"]
...
def load_and_preprocess():
    ...
    print("Step 2: Loading CFD Reference and Sensitivity data (river_urban_split)...")
    ...
    print(f"CFD Ref: {df_cfd_ref.shape}, Sen (river_urban_split): {df_cfd_sen.shape}")

    # add layer index to ensure layer alignment
    ...
    # 3. merge CFD Sensitivity (river_urban_split)
